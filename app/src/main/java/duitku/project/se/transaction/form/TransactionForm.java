package duitku.project.se.transaction.form;

import android.content.Context;
import android.view.View;

import duitku.project.se.R;
import duitku.project.se.transaction.form.components.TransactionAdComponent;
import duitku.project.se.transaction.form.components.TransactionAmountComponent;
import duitku.project.se.transaction.form.components.TransactionCategoryComponent;
import duitku.project.se.transaction.form.components.TransactionDateComponent;
import duitku.project.se.transaction.form.components.TransactionDescriptionComponent;
import duitku.project.se.transaction.form.components.TransactionWalletComponent;
